  ...
  const about = h(
    ...
    { className: "about-copy" },
        h(
                "p",
                null,
                "Sabha is a small, invite-only dinner series — a handful of strangers and friends-of-friends around one table, a menu built for the night, nothing performative about it."
              ),
        h("p", { className: "fine" }, "Placeholder copy — swap in the real About text.")
      );
